 ...
 * </p>
 * <ul>
 *   <li>{@link myModel.impl.MemoryImpl#getBrand <em>Brand</em>}</li>
 *   <li>{@link myModel.impl.MemoryImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemoryImpl extends MinimalEObjectImpl.Container implements Memory {
	...
	protected EClass eStaticClass() {
		return MyModelPackage.Literals.MEMORY;
	}
	...
	public void setBrand(String newBrand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MEMORY__BRAND, oldBrand, brand));
	}
	...
	public void setSize(int newSize) {
		...
		size = newSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.MEMORY__SIZE, oldSize, size));
	}
