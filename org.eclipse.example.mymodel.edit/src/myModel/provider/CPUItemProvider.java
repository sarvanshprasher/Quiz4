...
/**
 * This is the item provider adapter for a {@link myModel.CPU} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CPUItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyModelPackage.Literals.CPU__SPEED,
				 true,
				 false,
				 false,
	...
	protected void addBrandPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CPU_brand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CPU_brand_feature", "_UI_CPU_type"),
				 MyModelPackage.Literals.CPU__BRAND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		CPU cpu = (CPU)object;
		return getString("_UI_CPU_type") + " " + cpu.getSpeed();
	}
