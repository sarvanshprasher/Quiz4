...
/**
 * This is the item provider adapter for a {@link myModel.Memory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_brand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_brand_feature", "_UI_Memory_type"),
				 MyModelPackage.Literals.MEMORY__BRAND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyModelPackage.Literals.MEMORY__SIZE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Memory)object).getBrand();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Memory.class)) {
			case MyModelPackage.MEMORY__BRAND:
			case MyModelPackage.MEMORY__SIZE:
