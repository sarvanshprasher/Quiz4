...
/**
 * This is the item provider adapter for a {@link myModel.Computer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Computer_brand_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Computer_brand_feature", "_UI_Computer_type"),
				 MyModelPackage.Literals.COMPUTER__BRAND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyModelPackage.Literals.COMPUTER__CPU);
			childrenFeatures.add(MyModelPackage.Literals.COMPUTER__MEMORIES);
		}
	...
	public String getText(Object object) {
		String label = ((Computer)object).getBrand();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MyModelPackage.Literals.COMPUTER__CPU,
				 MyModelFactory.eINSTANCE.createCPU()));

		newChildDescriptors.add
			(createChildParameter
				(MyModelPackage.Literals.COMPUTER__MEMORIES,
				 MyModelFactory.eINSTANCE.createMemory()));
	}
